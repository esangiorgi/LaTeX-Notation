...
\end{align*}
Aggiungiamo che lo stile del differenziale $\dd$ può essere impostato in italico $d$, l'opzione \texttt{ddit} nel preambolo così \texttt{\sh usepackage[ddit]\{latelib\}}.
